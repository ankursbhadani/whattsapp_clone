...
import 'features/auth/screens/update_user_information.dart';
...
Route<dynamic> generateRoute(RouteSettings settings) {
  switch (settings.name) {
    ...
    case UpdateUserInformationScreen.routeName:
      return MaterialPageRoute(builder: (context)=>const UpdateUserInformationScreen());
    default:
      return MaterialPageRoute(

...
import 'package:whattsapp_chat/features/auth/screens/update_user_information.dart';
            ...
            PopupMenuButton(
              ...
              itemBuilder: (context) => [
                ...
                PopupMenuItem(
                  ...
                  onTap: () {
                    Navigator.of(context).push(MaterialPageRoute(builder: (context)=>UpdateUserInformationScreen()));
